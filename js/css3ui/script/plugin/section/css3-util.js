$(document).ready(function () {
    ...
    $.fn.myLightBox = function (thisHtml) {
        ...
        elBox.css({
            'width': '100%', 'height': sH, 'background': 'rgba(71,71,71,0.4)', 'display': 'flex', 'flex': '1', 'padding-top': scrollH,
    ...
    */
    ...
    $.fn.vidangeUI = function () {
        ...
        $('#3ui-panelControl input,#3ui-panelControl select').each(function () {
            ...
            } else if (myInput.format === 'transform') {
                $(this).val('');
    ...
    $.fn.updateListSelect = function (elData) {
        ...
        if (elData.groupformat === 'ruleHtml') {
            ...
            dataListSelect = {
                idlinkgroup: elData.groupParent.data('idlinkgroup'),
            ...
            if (elData.myBroth.hasClass('illuminate')) {
                ...
                dataListSelect = {
                    idlinkgroup: elData.idlinkgroup,
