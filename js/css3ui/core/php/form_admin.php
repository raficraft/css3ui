...
if(isset($options['input'])){        
  ...
  if(isset($options['html'])){ 
    /** Construction    **/   
        ...
        if($thisDuplicate == 1){  
        $r .= '<span class="bloc-duplicate"><a href="add-rule" data-actionUI="duplicate" data-duplicate="add-data" class="add-data">+</a>'
                . '<a href="del-rule" data-actionUI="duplicate" data-duplicate="del-data" class="del-data">-</a></span>';              
        }
